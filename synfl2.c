...
int main (void)
{
        ...
        tcph->dest = htons (80);       // DEST PORT 80, select carefully!!
        tcph->seq = 0;
        tcph->ack_seq = 0;
        ...
        tcph->check = 0;        // if you set a checksum to zero, your kernel's IP stack
                                // your kernels ipstack sould fill in the correct checksum during transmission */
        tcph->urg_ptr = 0;
        ...
        for (i=0; i<50; i++)
        {
               // sending 50 syns starting with SPT = 0
               send_port++;
